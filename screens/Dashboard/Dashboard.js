...
import { View, StyleSheet, AsyncStorage, TouchableOpacity, ImageBackground ,Icon ,Image, Dimensions} from "react-native";
            ...
            <ImageBackground
                ...
                <Avatar rounded size="xlarge" source={{ uri: img }} /> */}
                    <View style={styles.container}>
                        ...
                        <TouchableOpacity style={styles.btn} onPress={this.join.bind(this)}>
                        <MaterialIcons name="nature-people" size={25} style={styles.cirlcle_icon}  />
                            <Text style={styles.btn_text}>Join Circle</Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.btn} onPress={this.Invitation.bind(this)}>
                        <MaterialIcons name="insert-invitation" size={25} style={styles.cirlcle_icon}  />
                            <Text style={styles.btn_text}>Invitation List</Text>
                        </TouchableOpacity>
                    </View>
